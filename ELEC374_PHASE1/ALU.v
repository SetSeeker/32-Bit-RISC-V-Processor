module ALU #(parameter DATA_WIDTH = 32)(
	...
	wire [DATA_WIDTH-1:0] add_result, suresult;
	...
	reg [DATA_WIDTH-1:0]  result, PC, q;
	...
	always @(*) begin
		case(control)
			...
			4'd2:	result = {32'd0, and_result};
			4'd3:	result = {32'd0, and_result};
			4'd4:	result = {32'd0, and_result};
